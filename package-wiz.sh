...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-MAIN-DESC"  "Install Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-NOTES" "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-MAIN-TITLE" "Arch Wizard Main Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-MAIN-MENU-SAVE" "Save Software Configuration for later use"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-COMPLETED" "Completed" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-INSTALLED" "Installed" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-REMOVED"   "Removed" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-REC"       "Recommended Options" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-MAIN-MENU-1"    "Wizard" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-1"        "Wizard: Install packages via a Wizard." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-2"    "Basic Setup" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-2"        "Basic Setup: Required: SYSTEMD, Video Card, Network, DBUS, AVAHI, ACPI, ALSA, (UN)COMPRESS TOOLS, NFS, SAMBA, XORG, CUPS, SSH and more." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-3"    "Desktop Environment" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-3"        "Desktop Environment: Mate, Razor-Qt, KDE, XFCE, Awesome, Cinnamon, E17, LXDE, OpenBox, GNOME and even Unity." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-4"    "Display Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-4"        "Display Manager: GDM, Elsa, LightDM, LXDM and Slim." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-5"    "Accessories Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-5"       "Accessories Apps: cairo-dock-bzr, Conky, deepin-scrot, dockbarx, speedcrunch, galculator, gnome-pie, guake, kupfer, pyrenamer, shutter, synapse, terminator, zim, Revelation." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-6"    "Development Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-6"       "Development Apps: Qt and Creator, Wt, Aptana-Studio, Bluefish, Eclipse, Emacs, Gvim, Geany, IntelliJ IDEA, DDevelop, Oracle Java, Sublime Text 2, Debugger Tools, PostgreSQL, MySQL Workbench, Meld, RabbitVCS, Astyle and Putty." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-7"    "Office Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-7"       "Office Apps: Libre Office, Calligra (KOffice Suite Replacement) or Abiword + Gnumeric, latex, calibre, gcstar, homebank, impressive, nitrotasks, ocrfeeder, xmind and zathura." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-8"    "System Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-8"       "System Apps: Gparted, Grsync, Htop, Virtualbox, Webmin, WINE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-9"    "Internet Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-9"       "Internet Apps: Browsers, Download / Fileshare, Email / RSS, Instant Messaging, Internet Relay Chat, Mapping Tools, VNC / Desktop Share" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-10"   "Graphics Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-10"      "Graphics Apps: Blender, Handbrake, CD/DVD Burners, Gimp, Gthumb, Inkscape, Mcomix, MyPaint, Scribus, Shotwell, Simple-scan, Xnviewmp, Qt Image Viewers, Qt Image Editors" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-11"   "Audio Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-11"      "Audio Apps: Players, Editors / Tools, Codecs" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-12"   "Video Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-12"      "Video Apps: Players, Editors / Tools, Codecs" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-13"   "Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-13"      "Games: Sub Menu... too many Games to Mention." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-14"   "Science" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-14"      "Science and Education: ${INSTALL_SCIENCE_EDUCATION}." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-15"   "Web Server" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-15"      "Web Server: Apache, Tools, Databases: PostgreSQL or MySQL." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-16"   "Fonts" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-16"      "Fonts: Sub Menu of many Fonts Available." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-17"   "Extra" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-17"      "Extra: Elementary Project, Yapan" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-18"   "Kernel" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-18"      "Install Optional Kernals: Liquorix, LTS, ZEN." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-19"   "Clean Orphan Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-19"      "Clean Orphan Packages: pacman clean up" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-20"   "Edit Configuration" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-20"      "Edit Configuration: Loads Saved Software." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-21"   "Load Custom Software" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-21"      "Load Custom Software: Not yet written." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-22"   "Load Software" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-22"      "Load Software: Allows you to review and edit configuration variables before installing software." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-23"   "Save Software" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-23"      "Save Software: Saves and Installs list and configurations creates with this menu." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-24"   "Quit" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-24"      "Quit Menu: If in Boot mode will run pacstrap, if in software mode will install Software." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-24-L" "Save and Install Software" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAIN-MENU-I-24-L"    "Save and Install Software: Just that easy." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_main_menu()
{
    ...
    while [[ 1 ]]; do
        ...
        for OPT in ${OPTIONS[@]}; do
            case "$OPT" in
                1)  # Wizard
                    run_install_wizard
                    StatusBar1="INSTALL-MAIN-MENU-$OPT"
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-WIZARD-MENU-USAGE" "run_install_wizard" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WIZARD-MENU-DESC"  "Install Wizard Now will Launch the Script in Wizard Mode." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WIZARD-MENU-NOTES" "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-WIZARD-MENU-BASIC" "Reconfigure Basic Setup" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
run_install_wizard()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-TYPE-DESC"   "Install Type Menu: " "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-TYPE-NOTES"  "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-TYPE-TITLE"  "Type of Installation:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-TYPE-MENU-1"   "Normal" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-TYPE-MENU-I-1"       "Normal: Minimal well rounded Applications." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-TYPE-MENU-2"   "Gamer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-TYPE-MENU-I-2"       "Gamer: Normal plus a lot of Games." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-TYPE-MENU-3"   "Professional" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-TYPE-MENU-I-3"       "Professional: Normal plus Video and Audio Applications." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-TYPE-MENU-4"   "Programmer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-TYPE-MENU-I-4"       "Programmer: Professional plus some important Programming Applications." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    # 0=Normal, 1=Gamer, 2=Professional and 3=Programmer
fi
# -------------------------------------
install_type_menu()
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Normal
                    ...
                    INSTALL_TYPE=0
                    # Progress Status
                    StatusBar1="INSTALL-TYPE-MENU-$S_OPT"
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-CUSTOM-DE-DESC"   "Install Custom Desktop Menu: " "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-NOTES"  "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-TITLE"  "Custom Desktop Menu:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-CUSTOM-DE-MENU-1"   "Mate" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-I-1"      "Mate: The MATE Desktop Environment is a fork of GNOME 2 that aims to provide an attractive and intuitive desktop to Linux users using traditional metaphors" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-2"   "KDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-I-2"      "KDE: The KDE Software Compilation is the set of libraries, workspaces, and applications produced by KDE that share this common heritage, and continue to use the synchronized release cycle." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-3"   "XFCE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-I-3"      "XFCE: Xfce embodies the traditional UNIX philosophy of modularity and re-usability." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-4"   "Razor-QT & Openbox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-I-4"      "Razor-QT & Openbox: Razor-qt is an advanced, easy-to-use, and fast toolbox-like desktop environment, which is, like KDE, based on Qt technologies. Openbox is a lightweight and highly configurable window manager with extensive standards support." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-5"   "Cinnamon" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-I-5"      "Cinnamon: Cinnamon is a Linux desktop which provides advanced innovative features and a traditional user experience." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-6"   "Awesome" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUSTOM-DE-MENU-I-6"      "Awesome: awesome is a highly configurable, next generation framework window manager for X." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_custom_de_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Mate
                    ...
                    CUSTOM_DE=1
                    # Progress Status
                    StatusBar1="INSTALL-CUSTOM-DE-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    S_OPT="$BreakableKey"
                    break;
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-BASICS-MENU-DESC"    "Install Basics Menu: Default Base Settings." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-NOTES"   "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-TITLE"   "Basic Installation" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-REC"     "Recommended Settings" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-DEFAULT" "Default" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-BASICS-MENU-1"    "NFS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-1"      "NFS: allowing a user on a client computer to access files over a network in a manner similar to how local storage is accessed." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-2"    "SAMBA" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-2"      "SAMBA: SAMBA is a re-implementation of the SMB/CIFS networking protocol, it facilitates file and printer sharing among Linux and Windows systems as an alternative to NFS. https://wiki.archlinux.org/index.php/Samba" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-3"    "Laptop Mode Tools" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-3"      "Laptop Mode Tools: is a laptop power saving package for Linux systems. It is the primary way to enable the Laptop Mode feature of the Linux kernel, which lets your hard drive spin down. In addition, it allows you to tweak a number of other power-related settings using a simple configuration file. - https://wiki.archlinux.org/index.php/Laptop_Mode_Tools" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-4"    "Preload" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-4"      "Preload: is a program which runs as a daemon and records statistics about usage of programs using Markov chains; files of more frequently-used programs are, during a computer's spare time, loaded into memory. This results in faster startup times as less data needs to be fetched from disk. preload is often paired with prelink. - https://wiki.archlinux.org/index.php/Preload" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-5"    "Zram" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-5"      "Zram: creates a device in RAM and compresses it. If you use for swap means that part of the RAM can hold much more information but uses more CPU. Still, it is much quicker than swapping to a hard drive. If a system often falls back to swap, this could improve responsiveness. Zram is in mainline staging (therefore its not stable yet, use with caution). As a side note, check to see if you are even using the swap disk, more memory is a better option, but this is a good alternative if you keep hitting the swap disk. - https://wiki.archlinux.org/index.php/Maximizing_Performance" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-6"    "Tor" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-6"      "Tor: is an open source implementation of 2nd generation onion routing that provides free access to an anonymous proxy network. Its primary goal is to enable online anonymity by protecting against traffic analysis attacks." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-7"    "CUPS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-7"      "CUPS: is the standards-based, open source printing system developed by Apple Inc. for Mac OS® X and other UNIX®-like operating systems." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-8"    "USB 3G MODEM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-8"      "USB 3G MODEM: A number of mobile telephone networks around the world offer mobile internet connections over UMTS (or EDGE or GSM) using a portable USB modem device." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-9"    "Addition Firmwares" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-9"      "Addition Firmwares: Install additional firmwares (Audio,Bluetooth,Scanner,Wireless) - alsa-firmware, ipw2100-fw, ipw2200-fw, b43-firmware, b43-firmware-legacy, broadcom-wl, zd1211-firmware, bluez-firmware, libffado, libraw1394, sane-gt68xx-firmware" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-10"   "AUR Helper" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-10"     "Change AUR Helper: yaourt, packer or pacaur" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-11"   "Network Managers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-11"     "Network Managers: NetworkManager or WICD" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-12"   "Video Card" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASICS-MENU-I-12"     "Select Video Card: nVidia, Nouveau, Intel, ATI, Vesa, Virtualbox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_basics_menu()
{
    ...
    if [[ "$INSTALL_NFS" -eq 1 ]]; then
        MenuChecks[0]=1                             # Check these, it means they are already Installed
    fi
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # NFS
                        ...
                        MenuChecks[$((S_OPT - 1))]=1
                        INSTALL_NFS=1
                        StatusBar1="INSTALL-BASICS-MENU-$S_OPT"
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-BASIC-USAGE" "install_basic 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-DESC"  "Install Basic Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-NOTES" "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_basic()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-BASIC-SETUP-USAGE"           "install_basic_setup 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-DESC"            "Install Basic Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-NOTES"           "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-BASIC-SETUP-TITLE"           "The Following will be installed by Default." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-INFO-SYSTEMD"    "SYSTEMD" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-INFO-SYSTEMD-1"  "systemd is a replacement for the init daemon for Linux (either System V or BSD-style). It is intended to provide a better framework for expressing services' dependencies, allow more work to be done in parallel at system startup, and to reduce shell overhead." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-INFO-BASH-TOOLS" "BASH TOOLS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-ARCHIVE-TOOLS"   "(UN)COMPRESS TOOLS - https://wiki.archlinux.org/index.php/P7zip" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-INFO-AVAHI"      "AVAHI" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-INFO-AVAHI-1"    "Avahi is a free Zero Configuration Networking (Zeroconf) implementation, including a system for multicast DNS/DNS-SD service discovery. It allows programs to publish and discover services and hosts running on a local network with no specific configuration." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-INFO-ACPI"       "ACPI" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-ACPI-1"          "acpid is a flexible and extensible daemon for delivering ACPI events." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-ALSA"            "ALSA" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-ALSA-1"          "The Advanced Linux Sound Architecture (ALSA) is a Linux kernel component intended to replace the original Open Sound System (OSSv3) for providing device drivers for sound cards." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-NTFS-1"          "NTFS/FAT/exFAT" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-NTFS-2"          "A file system (or filesystem) is a means to organize data expected to be retained after a program terminates by providing procedures to store, retrieve and update data, as well as manage the available space on the device(s) which contain it. A file system organizes data in an efficient manner and is tuned to the specific characteristics of the device." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-SSH-1"           "SSH" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-SSH-2"           "Secure Shell (SSH) is a network protocol that allows data to be exchanged over a secure channel between two computers." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-BASIC-SETUP-XORG-TITLE"      "XORG" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-XORG-INFO-1"     "Xorg is the public, open-source implementation of the X window system version 11." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-XORG-INFO-2"     "Installing X-Server (req. for Desktop Environment, GPU Drivers, Keyboardlayout,...)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BASIC-SETUP-XORG-SELECT"     "Select keyboard layout:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_basic_setup()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-USB-MODEM-NOW-USAGE"   "install_usb_modem_now 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-USB-MODEM-NOW-DESC"    "Install USB Modem" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-USB-MODEM-NOW-NOTES"   "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-USB-MODEM-NOW-TITLE"   "USB 3G MODEM"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-USB-MODEM-NOW-INFO"    "A number of mobile telephone networks around the world offer mobile internet connections over UMTS (or EDGE or GSM) using a portable USB modem device."  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-GIT-TOR-USAGE" "install_git_tor_now 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GIT-TOR-DESC"  "Install GIT TOR Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GIT-TOR-NOTES" "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-GIT-TOR-TITLE" "GIT-TOR" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GIT-TOR-INFO"  "Tor is an open source implementation of 2nd generation onion routing that provides free access to an anonymous proxy network. Its primary goal is to enable online anonymity by protecting against traffic analysis attacks." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_git_tor_now()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-NFS-USAGE" "install_nfs_now 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-NFS-DESC"  "Install NFS Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-NFS-NOTES" "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-NFS-TITLE" "NFS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-NFS-INFO"  "NFS allowing a user on a client computer to access files over a network in a manner similar to how local storage is accessed." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_nfs_now()
{
    ...
    if [[ "$INSTALL_NFS" -eq 1 ]]; then
        ...
        if add_packagemanager "package_install \"$INSTALL_NFS_PACKAGES\" 'INSTALL-NFS'" "INSTALL-NFS" ; then
            ...
            add_packagemanager "systemctl enable rpc-statd.service"  "SYSTEMD-ENABLE-NFS-1"
            add_packagemanager "systemctl enable rpc-mountd.service" "SYSTEMD-ENABLE-NFS-2"          
            # https://wiki.archlinux.org/index.php/NFS  
            # @FIX make an import export function so you can push them into 
            # echo "/srv/nfs4/music 192.168.0.1/24(rw,no_subtree_check,nohide)" >> /etc/exports
            # then create a mount script and put it in scripts folder
        fi
        if [[ "$SHOW_PAUSE" -eq 1 ]]; then pause_function "$FUNCNAME @ $(basename $BASH_SOURCE) : $LINENO"; fi
    fi
}
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-SAMBA-USAGE" "install_samba_now 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SAMBA-DESC"  "Install samba Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SAMBA-NOTES" "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-SAMBA-TITLE" "SAMBA" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SAMBA-INFO"  "Samba is a re-implementation of the SMB/CIFS networking protocol, it facilitates file and printer sharing among Linux and Windows systems as an alternative to NFS." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_samba_now()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-PRELOAD-USAGE" "install_preload_now 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PRELOAD-DESC"  "Install preload Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PRELOAD-NOTES" "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-PRELOAD-TITLE" "PRELOAD" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PRELOAD-INFO"  "Preload is a program which runs as a daemon and records statistics about usage of programs using Markov chains; files of more frequently-used programs are, during a computer's spare time, loaded into memory. This results in faster startup times as less data needs to be fetched from disk. preload is often paired with prelink." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_preload_now()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-ZRAM-USAGE" "install_zram_now 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ZRAM-DESC"  "Install zram Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ZRAM-NOTES" "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-ZRAM-TITLE" "ZRAM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ZRAM-INFO"  "Zram creates a device in RAM and compresses it. If you use for swap means that part of the RAM can hold much more information but uses more CPU. Still, it is much quicker than swapping to a hard drive. If a system often falls back to swap, this could improve responsiveness. Zram is in mainline staging (therefore its not stable yet, use with caution)." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_zram_now()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-LAPTOP-MODE-TOOLS-USAGE" "install_laptop_mode_tools_now 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LAPTOP-MODE-TOOLS-DESC"  "Install LAPTOP-MODE-TOOLS Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LAPTOP-MODE-TOOLS-NOTES" "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-LAPTOP-MODE-TOOLS-TITLE" "LAPTOP MODE TOOLS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LAPTOP-MODE-TOOLS-INFO"  "Laptop Mode Tools is a laptop power saving package for Linux systems. It is the primary way to enable the Laptop Mode feature of the Linux kernel, which lets your hard drive spin down. In addition, it allows you to tweak a number of other power-related settings using a simple configuration file." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-CUPS-USAGE" "install_cups_now 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUPS-DESC"  "Install Cups." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUPS-NOTES" "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-CUPS-YN"    "Install CUPS - AKA Common Unix Printing System"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUPS-TITLE" "CUPS - AKA Common Unix Printing System"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CUPS-INFO"  "CUPS is the standards-based, open source printing system developed by Apple Inc. for Mac OS® X and other UNIX®-like operating systems."  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_cups_now()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-USAGE"   "install_additional_firmwares_menu 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-DESC"    "Install Addition Firmwares" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-NOTES"   "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-TITLE"   "INSTALL ADDITIONAL FIRMWARES" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-INFO"    "alsa-firmware, ipw2100-fw, ipw2200-fw, b43-firmware, b43-firmware-legacy, broadcom-wl, zd1211-firmware, bluez-firmware, libffado, libraw1394, sane-gt68xx-firmware" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-INSTALL" "Install additional firmwares (Audio,Bluetooth,Scanner,Wireless)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-1"    "alsa-firmware" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-1"        "alsa-firmware: ALSA firmware package" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-2"    "ipw2100-fw" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-2"        "ipw2100-fw: Intel Centrino Drivers firmware for IPW2100" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-3"    "ipw2200-fw" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-3"        "ipw2200-fw: Firmware for the Intel PRO/Wireless 2200BG" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-4"    "b43-firmware" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-4"        "b43-firmware: Firmware for Broadcom B43 wireless networking chips" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-5"    "b43-firmware-legacy" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-5"        "b43-firmware-legacy: Firmware for legacy Broadcom B43 wireless networking chips" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-6"    "broadcom-wl" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-6"        "broadcom-wl: Broadcom 802.11abgn hybrid Linux networking device driver" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-7"    "zd1211-firmware" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-7"        "zd1211-firmware: Firmware for the in-kernel26 zd1211rw wireless driver" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-8"    "bluez-firmware" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-8"        "bluez-firmware: Firmwares for Broadcom BCM203x and STLC2300 Bluetooth chips" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-9"    "libffado" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-9"        "libffado: Driver for FireWire audio devices" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-10"   "libraw1394" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-10"       "libraw1394: Provides an API to the Linux IEEE1394 (FireWire) driver" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-11"   "sane-gt68xx-firmware" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ADDITIONAL-FIRMWARE-MENU-I-11"       "sane-gt68xx-firmware: gt68xx-based scanners firmwares" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
            ...
            for S_OPT in ${OPTIONS[@]}; do
                case "$S_OPT" in
                    1)  # alsa-firmware
                        ...
                        INSTALL_FIRMWARE=1
                        # Progress Status
                        StatusBar1="INSTALL-ADDITIONAL-FIRMWARE-MENU-$S_OPT"
                        StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                        print_caution "$StatusBar1"  "$StatusBar2"
                        ;;
                    2)  # ipw2100-fw
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-KERNEL-DESC"   "Install Kernel Menu: " "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KERNEL-NOTES"  "NONE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KERNEL-TITLE"  "Kernel Installation:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    # Liquorix, LTS, ZEN
    localize_info "INSTALL-KERNEL-MENU-0"   "Liquorix" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KERNEL-MENU-I-0"     "Liquorix: is a distro kernel replacement built using the best configuration and kernel sources for desktop, multimedia, and gaming workloads, often used as a Debian Linux performance replacement kernel. damentz, the maintainer of the Liquorix patchset, is a developer for the Zen patchset as well, so many of the improvements there are found in this patchset. http://liquorix.net/" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KERNEL-MENU-1"   "LTS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KERNEL-MENU-I-1"     "Long term support (LTS): Linux kernel and modules from the [core] repository." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KERNEL-MENU-2"   "ZEN" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KERNEL-MENU-I-2"     "The Zen Kernel: is a the result of a collaborative effort of kernel hackers to provide the best Linux kernel possible for every day systems. https://github.com/damentz/zen-kernel?" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #localize_info "INSTALL-KERNEL-MENU-3"   "" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #localize_info "INSTALL-KERNEL-MENU-I-3"     "" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_kernel_menu()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-DESC"    "Install Desktop Environment" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-TITLE"   "Desktop Environment" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-INFO-1"  "A Desktop environments (DE) provide a complete graphical user interface (GUI) for a system by bundling together a variety of X clients written using a common widget toolkit and set of libraries." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-INFO-2"  "Mate, KDE, XFCE, Awesome, Cinnamon, E17, LXDE, OpenBox, GNOME, and Unity" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-1"    "Mate" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-1-D"      "The Way Gnome should be..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-1-W"        "Installs from repo.mate-desktop.org" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-1-I"            "Mate: Fork of Gnome 2.x" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-2"    "KDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-2-I"      "KDE: KDE software consists of a large number of individual applications and a desktop workspace as a shell to run these applications. https://wiki.archlinux.org/index.php/KDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-3"    "XFCE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-3-I"      "XFCE: Xfce embodies the traditional UNIX philosophy of modularity and re-usability. It consists of a number of components that provide the full functionality one can expect of a modern desktop environment, while remaining relatively light. https://wiki.archlinux.org/index.php/Xfce" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-4"    "Razor-qt" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-4-I"      "Razor-qt: [unsupported] is an advanced, easy-to-use, and fast desktop environment based on Qt technologies. It has been tailored for users who value simplicity, speed, and an intuitive interface. While still a new project, Razor-qt already contains all the key DE components. https://wiki.archlinux.org/index.php/Razor-qt" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-5"    "Cinnamon" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-5-I"      "Cinnamon: Cinnamon is a fork of Gnome 3. Cinnamon strives to provide a traditional user experience, similar to Gnome 2. https://wiki.archlinux.org/index.php/Cinnamon" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-6"    "E17" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-6-I"      "E17: The Enlightenment desktop shell provides an efficient yet breathtaking window manager based on the Enlightenment Foundation Libraries along with other essential desktop components like a file manager, desktop icons and widgets. https://wiki.archlinux.org/index.php/E17" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-7"    "LXDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-7-I"      "LXDE: The 'Lightweight X11 Desktop Environment' is a fast and energy-saving desktop environment. Maintained by an international community of developers, it comes with a beautiful interface, multi-language support, standard keyboard short cuts and additional features like tabbed file browsing. Fundamentally designed to be lightweight, LXDE uses less CPU and RAM than other environments. https://wiki.archlinux.org/index.php/LXDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-8"    "GNOME" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-8-I"      "GNOME: The GNOME project provides two things: The GNOME desktop environment, an attractive and intuitive desktop for users, and the GNOME development platform, an extensive framework for building applications that integrate into the rest of the desktop. GNOME is free, usable, accessible, international, developer-friendly, organized, supported, and a community. https://wiki.archlinux.org/index.php/GNOME" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-9"    "GNOME DE Extras" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-9-I"      "Gnome Desktop Extras Sub Menu: GNOME Icons, GTK Themes and even Unity" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-MENU-10"   "Window Managers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    ...
    #
    localize_info "INSTALL-DESKTOP-ENVIRONMENT-REC"       "Recommended Options" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Mate
                    ...
                    install_mate_now
                    # Progress Status
                    StatusBar1="INSTALL-DESKTOP-ENVIRONMENT-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # KDE
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-WINDOW-MANAGER-DESC"    "Install Window Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WINDOW-MANAGER-TITLE"   "Window Environment" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WINDOW-MANAGER-INFO-1"  "A Desktop environments (DE) provide a complete graphical user interface (GUI) for a system by bundling together a variety of X clients written using a common widget toolkit and set of libraries." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WINDOW-MANAGER-INFO-2"  "Mate, KDE, XFCE, Awesome, Cinnamon, E17, LXDE, OpenBox, GNOME, and Unity" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-WINDOW-MANAGER-MENU-1"    "Awesome" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WINDOW-MANAGER-MENU-1-I"      "Awesome: awesome is a highly configurable, next generation framework window manager for X. It is very fast, extensible and licensed under the GNU GPLv2 license. Configured in Lua, it has a system tray, information bar, and launcher built in. There are extensions available to it written in Lua. Awesome uses XCB as opposed to Xlib, which may result in a speed increase. Awesome has other features as well, such as an early replacement for notification-daemon, a right-click menu similar to that of the *box window managers, and many other things." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WINDOW-MANAGER-MENU-2"    "OpenBox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WINDOW-MANAGER-MENU-2-I"      "OpenBox: Openbox is a lightweight and highly configurable window manager with extensive standards support. Its features are documented at the official website. This article pertains to installing Openbox under Arch Linux." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-WINDOW-MANAGER-REC"       "Recommended Options" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_window_manager_menu() 
{ 
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Awesome
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-WINDOW-MANAGER-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # OpenBox
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-MATE-DESC"    "Installs Mate Desktop." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MATE-TITLE"   "Mate"                   "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MATE-INFO-1"  "Install Mate Desktop - Recommended over Gnome, its like Gnome 2, without the Crazy Gnome 3 stuff." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MATE-INFO-2"  "Full List"              "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_mate_now()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-KDE-DESC"    "Install KDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-TITLE"   "KDE Customization" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-INFO-1"  "KDE is an international free software community producing an integrated set of cross-platform applications designed to run on Linux, FreeBSD, Microsoft Windows, Solaris and Mac OS X systems. It is known for its Plasma Desktop, a desktop environment provided as the default working environment on many Linux distributions." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-KDE-MENU-1"   "apper" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-I-1"        "apper: KDE tools for PackageKit" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-2"   "bangarang" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-I-2"        "bangarang: Simple KDE media player. AUR" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-3"   "choqok" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-I-3"        "choqok: A Twitter/identi.ca/laconica client for KDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-4"   "digikam" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-I-4"        "digikam: Digital photo management application for KDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-5"   "k3b" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-I-5"        "k3b: Feature-rich and easy to handle CD burning application" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-6"   "rosa-icons" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-I-6"        "rosa-icons: ROSA icons theme. AUR" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-7"   "Plasma Themes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-I-7"        "Plasma Themes: caledonia-bundle, plasma-theme-rosa, ronak-plasmatheme" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-8"   "yakuake" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-KDE-MENU-I-8"        "yakuake: A drop-down terminal emulator based on KDE konsole technology" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_kde_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # apper
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-KDE-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # bangarang
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-GNOME-DESC"      "Install Gnome" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-NOTES"     "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-TITLE"     "GNOME Customization" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-GNOME-INFO-1"    "GNOME is a desktop environment and graphical user interface that runs on top of a computer operating system. It is composed entirely of free and open source software. It is an international project that includes creating software development frameworks, selecting application software for the desktop, and working on the programs that manage application launching, file handling, and window and task management." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-INFO-2"    "GNOME Shell Extensions: disper gpaste gnome-shell-extension-gtile-git gnome-shell-extension-mediaplayer-git gnome-shell-extension-noa11y-git gnome-shell-extension-pomodoro-git gnome-shell-extension-user-theme-git gnome-shell-extension-weather-git gnome-shell-system-monitor-applet-git" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-INFO-3"    "GNOME Shell Themes: gnome-shell-theme-default-mod gnome-shell-theme-dark-shine gnome-shell-theme-elegance gnome-shell-theme-eos gnome-shell-theme-frieze gnome-shell-theme-google+" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-GNOME-MENU-1"    "GNOME Shell Extensions" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-I-1"        "GNOME Shell Extensions: Sub Menu: User-created extensions for the GNOME Shell environment" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-2"    "GNOME Shell Themes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-I-2"        "GNOME Shell Themes: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-3"    "GNOME Packagekit" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-I-3"        "GNOME Packagekit: Collection of graphical tools for PackageKit to be used in the GNOME desktop" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-4"    "activity-journal" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-I-4"        "activity-journal: Tool for easily browsing and finding files on your computer using the Zeitgeist engine" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-5"    "activity-log-manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-I-5"        "activity-log-manager: A graphical user interface which lets you easily control what gets logged by Zeitgeist" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-6"    "gloobus-sushi-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-MENU-I-6"        "gloobus-sushi-bzr: GloobusPreview replacement for Gnome Sushi" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_gnome_menu()
{
    ...
    if add_packagemanager "package_install \"$INSTALL_GNOME\" 'INSTALL-GNOME'" "INSTALL-GNOME" ; then
        ...
        if add_packagemanager "aur_package_install \"$AUR_INSTALL_GNOME\" 'AUR-INSTALL-GNOME'" "AUR-INSTALL-GNOME" ; then
            add_aur_package "$AUR_INSTALL_GNOME"
        fi
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # GNOME Shell Extensions
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-GNOME-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-DESC"     "Install Gnomeshell Extensions" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-1"   "Disper" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-I-1"      "disper: An on-the-fly display switch utility, intended to be used on laptops, especially with nVidia cards." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-2"   "Gpaste" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-I-2"      "gpaste: Clipboard management system with a gnome-shell extension" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-3"   "Mediaplayer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-I-3"      "mediaplayer: A mediaplayer indicator for the Gnome Shell" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-4"   "Noa11y" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-I-4"      "noa11y: A gnome-shell extension to remove the accessibility icon from the panel" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-5"   "Pomodoro" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-I-5"      "pomodoro: GNOME Shell extension for pomodoro technique." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-6"   "System-monitor-applet" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-I-6"      "System-monitor-applet: System monitor extension for Gnome-Shell (display mem swap cpu usage)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-7"   "User-theme" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-I-7"      "user-theme: Allows a custom shell theme to be loaded." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-8"   "Weather" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-I-8"      "weather: A GNOME Shell extension for displaying weather notifications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-9"   "Gtile" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-EXTENSIONS-MENU-I-9"      "gtile: A GNOME Shell Extension to tile your windows as you like. It even supports multiscreen" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_gnome_menushell_extensions_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # disper
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-GNOMESHELL-EXTENSIONS-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # gpaste - currently fails
                    MenuChecks[$((SS_OPT - 1))]=1
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-GNOMESHELL-THEMES-DESC"   "Install Gnomeshell Themes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-1"   "default-mod" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-I-1"       "default-mod: A GNOME Shell theme based on the stock GTK theme. gnome-shell-theme-default-mod" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-2"   "dark-shine" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-I-2"       "dark-shine: Dark variant of the shine theme. gnome-shell-theme-dark-shine" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-3"   "elegance" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-I-3"       "elegance: A clean and elegant HUD theme for Gnome Shell 3.6. gnome-shell-theme-elegance" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-4"   "eos" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-I-4"       "eos: This is a GNOME Shell theme based on the Elementary GTK2 theme. gnome-shell-theme-eos" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-5"   "frieze" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-I-5"       "frieze: Gnome Shell + GDM Theme. gnome-shell-theme-frieze" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-6"   "google" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOMESHELL-THEMES-MENU-I-6"       "google: A Gnome-Shell theme by plaidcounty, based on the Google color schema. gnome-shell-theme-google" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_gnome_menushell_themes_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # default-mod
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-GNOMESHELL-THEMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # dark-shine
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-AWESOME-DESC"   "Install Awesome" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AWESOME-TITLE"  "AWESOME" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AWESOME-INFO-1" "awesome is a highly configurable, next generation framework window manager for X. It is very fast, extensible and licensed under the GNU GPLv2 license." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AWESOME-INFO-2" "AWESOME CUSTOMIZATION" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AWESOME-REC"    "Recommended Options" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
fi
# -------------------------------------
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-OPENBOX-DESC"      "Install Openbox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OPENBOX-TITLE"     "OPENBOX" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OPENBOX-INFO-1"    "Openbox is a lightweight and highly configurable window manager with extensive standards support." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OPENBOX-INFO-2"    "OPENBOX CUSTOMIZATION" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-COMMON-APPS-DESC"      "Install Common Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-TITLE"     "Install Common Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-COMMON-APPS-MENU-1"    "xcompmgr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-1"        "xcompmgr: Composite Window-effects manager for X.org" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-2"    "viewnior" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-2"        "viewnior: A simple, fast and elegant image viewer program" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-3"    "gmrun" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-3"        "gmrun: A simple program which provides a run program window" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-4"    "PCManFM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-4"        "PCManFM: An extremely fast and lightweight file manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-5"    "rxvt-unicode" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-5"        "rxvt-unicode: An unicode enabled rxvt-clone terminal emulator (urxvt)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-6"    "scrot" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-6"        "scrot: Print Screen - A simple command-line screenshot utility for X" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-7"    "thunar" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-7"        "thunar: Modern file manager for Xfce" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-8"    "tint2" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-8"        "tint2: A basic, good-looking task manager for WMs" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-9"    "volwheel" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-9"        "volwheel: Tray icon to change volume with the mouse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-10"   "xfburn" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-10"       "xfburn: A simple CD/DVD burning tool based on libburnia libraries" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-11"   "qasmixer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-11"       "qasmixer: Volume Manager for ALSA in Qt." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-12"   "qtfm" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-12"       "qtfm: Qt File Manager." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-13"   "qterminal" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-13"       "qterminal: Qt Terminal" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-14"   "qpdfview" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-COMMON-APPS-MENU-I-14"      "qpdfview: Qt PDF View" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # xcompmgr
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-COMMON-APPS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # viewnior
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-RAZOR-QT-DESC"   "Install Razor-Qt" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_razor_qt_common() # Where Common is install_common_apps_menu
{
    # 4
    local RecommendedOptions="1-10 12-14"        # Recommended Options to run in AUTOMAN or INSTALL_WIZARD Mode
    #
    if [[ "$INSTALL_TYPE" -eq 0 ]]; then   # Normal
        RecommendedOptions="$RecommendedOptions"        
    elif [[ "$INSTALL_TYPE" -eq 1 ]]; then # Gamer
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-CINNAMON-DESC"  "Install Cinnamon" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-CINNAMON-TITLE"  "CINNAMON" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-INFO-1" "Cinnamon is a fork of GNOME Shell, initially developed by Linux Mint. It attempts to provide a more traditional user environment based on the desktop metaphor, like GNOME 2. Cinnamon uses Muffin, a fork of the GNOME 3 window manager Mutter, as its window manager." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-INFO-2" "CINNAMON CUSTOMIZATION" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-INFO-3" "Installed Cinnamon" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-CINNAMON-MENU-1"   "Applets" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-MENU-I-1"       "Applets: Metapackage for Cinnamon Applets" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-MENU-2"   "Themes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-MENU-I-2"        "Themes: Metapackage for Cinnamon Themes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-MENU-3"   "GNOME Packagekit" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-MENU-I-3"        "GNOME Packagekit: Collection of graphical tools for PackageKit to be used in the GNOME desktop" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-MENU-4"   "GNOME Activity Journal" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-MENU-I-4"        "GNOME Activity Journal: A tool for easily browsing and finding files on your computer, developmental code." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-MENU-5"   "Gnome Sushi" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-CINNAMON-MENU-I-5"        "gloobus-sushi-bzr: GloobusPreview replacement for Gnome Sushi" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_cinnamon_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Applets - currently fails
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-CINNAMON-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Themes - currently fails
                    MenuChecks[$((S_OPT - 1))]=1
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-E17-DESC"   "Install E17" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-E17-TITLE"  "E17 or Enlightenment" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-E17-INFO-1" "Enlightenment, also known simply as E, is a stacking window manager for the X Window System which can be used alone or in conjunction with a desktop environment such as GNOME or KDE. Enlightenment is often used as a substitute for a full desktop environment." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-E17-INFO-2" "E17 Customization" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-E17-MENU-1"   "e17-icons" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-E17-MENU-I-1"     "e17-icons: Animated icons for E17 from exchange.enlightenment.org" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-E17-MENU-2"   "e17-themes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-E17-MENU-I-2"     "e17-themes: Themes for E17 desklock from exchange.enlightenment.org" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_e17_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # e17-icons
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-E17-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # e17-themes
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-LXDE-DESC"   "Install LXDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LXDE-TITLE"  "LXDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LXDE-INFO-1" "LXDE is a free and open source desktop environment for Unix and other POSIX compliant platforms, such as Linux or BSD. The goal of the project is to provide a desktop environment that is fast and energy efficient." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LXDE-INFO-2" "LXDE CUSTOMIZATION" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-XFCE-DESC"      "Install XFCE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-XFCE-TITLE"     "XFCE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-XFCE-INFO-1"    "Xfce is a free software desktop environment for Unix and Unix-like platforms, such as Linux, Solaris, and BSD. It aims to be fast and lightweight, while still being visually appealing and easy to use." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-XFCE-INFO-2"    "Install XFCE and Accessories." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-XFCE-MENU-1"    "xfce4-volumed" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-XFCE-MENU-I-1"        "xfce4-volumed: A volume keys control daemon for Xfce" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_xfce_menu() 
{ 
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # xfce4-volumed
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-XFCE-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                *)  # Catch ALL
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-UNITY-DESC"  "Install Unity" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-UNITY-TITLE" "Unity is an alternative shell for the GNOME desktop environment, developed by Canonical in its Ayatana project. It consists of several components including the Launcher, Dash, lenses, Panel, indicators, Notify OSD and Overlay Scrollbar." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-UNITY-CONTINUE" "Are you sure you wish to continue"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_unity_now() 
{ 
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-DISPLAY-MANAGER-DESC"   "Install Display Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-TITLE"  "Display Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-INFO-1" "A display manager, or login manager, is a graphical interface screen that is displayed at the end of the boot process in place of the default shell." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-1"   "GDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-1-I"          "Gnome Desktop Manager: Works with Gnome, Mate, XFCE, KDE, Awesome...: https://wiki.archlinux.org/index.php/GDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-2"   "KDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-2-I"          "KDM Display Manager: - QT Based, requires modification to work with xsessons: https://wiki.archlinux.org/index.php/KDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-3"   "Slim" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-3-I"          "SLIM: Simple Login Manager — lightweight and elegant graphical login solution: https://wiki.archlinux.org/index.php/SLiM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-4"   "LightDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-4-I"          "LightDM: Ubuntu replacement for GDM using WebKit: https://wiki.archlinux.org/index.php/LightDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-5"   "LXDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-5-I"          "LXDM: Display Manager. Can be used independent of the LXDE desktop environment: https://wiki.archlinux.org/index.php/LXDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-6"   "Qingy" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-6-I"          "Qingy: ultralight and very configurable graphical login independent on X Windows (uses DirectFB): https://wiki.archlinux.org/index.php/Qingy " "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-7"   "XDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-MENU-7-I"          "XDM: X Display Manager with support for XDMCP, host chooser: https://wiki.archlinux.org/index.php/XDM" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DISPLAY-MANAGER-REC"      "Recommended Options" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_display_manager_menu() 
{
    ...
    while [[ 1 ]];  do
        ...
        add_menu_item "MenuChecks" "MenuItems" "MenuInfo" "INSTALL-DISPLAY-MANAGER-MENU-6" ""  ""     "INSTALL-DISPLAY-MANAGER-MENU-6-I" "MenuTheme[@]" # 6 Qingy
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # GDM
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-DISPLAY-MANAGER-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    S_OPT="$BreakableKey"
                    break
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Elementary Project
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-EXTRA-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Yapan
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-ELEMENTARY-PROJECT-DESC"   "Install Elementary Project" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-INFO-1" "Note: Some of these programs still in alpha stage and may not work" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-1"   "Media Player" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-1"      "Media Player: A simple and modern media player - audience-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-2"   "Sharing service" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-2"      "Sharing service: A sharing service that allows source apps to send their data to registered destination apps - contractor-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-3"   "Screencasting" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-3"      "Screencasting: A simple screencasting app from the elementary project - eidete-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-4"   "Contacts Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-4"      "Contacts Manager: The contacts manager from the Elementary project - dexter-contacts-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-5"   "RSS Feeds Reader" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-5"      "RSS Feeds Reader: RSS feeds Reader from the Elementary Project - feedler-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-6"   "File Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-6"      "File Manager: A simple, powerful and sexy file manager from elementary (Marlin fork) - pantheon-files-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-7"   "Note Taking" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-7"      "Note Taking: A beautiful, fast, and simple note taking app in the style of elementary - footnote-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-8"   "Compositing Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-8"      "Compositing Manager: A window & compositing manager based on libmutter and designed by elementary - gala-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-9"   "Email client" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-9"      "Email client: A new lightweight, easy-to-use, feature-rich email client (beta version) - geary-git" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-10"   "Dictionary" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-10"      "Dictionary: Dictionary application from the Elementary project - lingo-dictionary-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-11"   "Calendar" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-11"      "Calendar: Calendar application written in Vala from the Elementary project - maya-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-12"   "Web Browser" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-12"      "Web Browser: Lightweight web browser based on Gtk WebKit - midori" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-13"   "Audio Player" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-13"      "Audio Player: The official audio player of elementary OS. - noise-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-14"   "Text Editor" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-14"      "Text Editor: A text editor written in Vala by elementary - scratch-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-15"   "Dock" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-15"      "Dock: A stupidly simple dock from elementary - plank-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-16"   "Terminal" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-16"      "Terminal: A super lightweight, beautiful, and simple terminal from the Elementary project - pantheon-terminal-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-17"   "App Launcher" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-17"      "App Launcher: A lightweight and stylish app launcher from elementary - slingshot-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-18"   "Desktop Settings Hub" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-18"      "Desktop Settings Hub: Modular desktop settings hub - switchboard-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-19"   "Indicators Topbar" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-19"      "Indicators Topbar: Stylish top panel that holds indicators and spawns an application launcher - wingpanel-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-20"   "Elementary Icons" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-20"      "Elementary Icons: An icon theme designed to be smooth, sexy, clear, and efficient (Development branch) - elementary-icons-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-21"   "Elementary Theme" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ELEMENTARY-PROJECT-MENU-I-21"      "Elementary Theme: Development branch of the elementary GTK theme. - egtk-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------feedler-bzr
install_elementary_project_menu()
{
    ...
    if [[ "$INSTALL_TYPE" -eq 0 ]]; then   # Normal
        ...
        RecommendedOptions="$RecommendedOptions 3 10 11 13 16 17 20 21"
    fi
    #
    RecommendedOptions="$RecommendedOptions $BreakableKey"
    #
    ...
    while [[ 1 ]]; do
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Media Player audience-bzr gtk3 currently fails
                    MenuChecks[$((SS_OPT - 1))]=1
                    if add_packagemanager "package_install \"$INSTALL_EP_AUDIENCE\" 'INSTALL-EP-AUDIENCE'" "INSTALL-EP-AUDIENCE" ; then
                        add_package "$INSTALL_EP_AUDIENCE" # 
                        if add_packagemanager "aur_package_install \"$AUR_INSTALL_EP_AUDIENCE\" 'AUR-INSTALL-EP-AUDIENCE'" "AUR-INSTALL-EP-AUDIENCE" ; then add_aur_package "$AUR_INSTALL_EP_AUDIENCE"; fi
                    fi
                    # Progress Status
                    StatusBar1="INSTALL-ELEMENTARY-PROJECT-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Sharing service
                ...
                3)  # Screencasting
                    ...
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                4)  # Contacts manager - currently failing
                    MenuChecks[$((SS_OPT - 1))]=1
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-AUDIO-APPS-DESC"   "Install Audio Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    # Players, Editors / Tools, Codecs
    localize_info "INSTALL-AUDIO-APPS-MENU-1"   "Players" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-APPS-MENU-I-1"      "Players: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-APPS-MENU-2"   "Editors / Tools" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-APPS-MENU-I-2"      "Editors / Tools: Sub Menu: soundconverter, puddletag, Audacity, Ocenaudio" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-APPS-MENU-3"   "Codecs" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-APPS-MENU-I-3"      "Codecs: gstreamer0.10-base, gstreamer0.10-good-plugins, mpg123, flac, faac, faad2, lame, libdca, wavpack" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_audio_apps_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Players
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-AUDIO-APPS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Editors | Tools
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-AUDIO-EDITORS-DESC"   "Install Audio Editors" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-AUDIO-EDITORS-MENU-1"   "Sound Converter" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-EDITORS-MENU-I-1"      "soundconverter: or soundkonverter Depending on DE." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-EDITORS-MENU-2"   "Puddle tag" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-EDITORS-MENU-I-2"      "puddletag: An audio tag editor for GNU/Linux (like Mp3tag)." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-EDITORS-MENU-3"   "Audacity" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-EDITORS-MENU-I-3"      "Audacity: A program that lets you manipulate digital audio waveforms." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-EDITORS-MENU-4"   "Ocenaudio" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-AUDIO-EDITORS-MENU-I-4"      "Ocenaudio: A cross-platform, easy to use, fast and functional audio editor." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_audio_editors_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # soundconverter
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-AUDIO-EDITORS-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # puddletag
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-PLAYERS-MENU-DESC"   "Install Players" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"

    localize_info "INSTALL-PLAYERS-MENU-MENU-1"   "Amarok" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-1"       "Amarok: The powerful music player for KDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-2"   "Audacious" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-2"       "Audacious: Lightweight, advanced audio player focused on audio quality with Plugins for Audacious" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-3"   "Banshee" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-3"       "Banshee: Music management and playback for GNOME" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-4"   "Clementine" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-4"       "Clementine: A music player and library organizer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-5"   "Dead beef" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-5"       "Dead beef: An audio player for GNU/Linux based on GTK2." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-6"   "Exaile" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-6"       "Exaile: A full-featured media player for GTK+" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-7"   "Musique" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-7"       "Musique: Just another music player, only better" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-8"   "Nuvola Player" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-8"       "Nuvola Player: Integrated Google Music, Grooveshark, 8tracks and Hype Machine player." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-9"   "Rhythmbox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-9"       "Rhythmbox: An iTunes-like music playback and management application" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-10"   "Radio tray" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-10"       "Radio tray: An online radio streaming player that runs on a Linux system tray." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-11"   "Spotify" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-11"       "Spotify: A proprietary peer-to-peer music streaming service" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-12"   "Tomahawk" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-12"       "Tomahawk: A Music Player App written in C++/Qt" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-13"   "Timidity++" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PLAYERS-MENU-MENU-I-13"       "Timidity++: A MIDI to WAVE converter and player" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_players_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Amarok
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-PLAYERS-MENU-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Audacious
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-OFFICE-APPS-DESC"      "Install Office Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-TITLE"     "Office Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-OFFICE-APPS-MENU-1"    "LibreOffice" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-1-I"        "Libre Office: LibreOffice is the free power-packed Open Source personal productivity suite for Windows, Macintosh and Linux, that gives you six feature-rich applications for all your document production and data processing needs: Writer, Calc, Impress, Draw, Math and Base. - https://wiki.archlinux.org/index.php/LibreOffice" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-2"    "Calligra or Abiword + Gnumeric" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-2-I"        "Calligra (Calligra is the new name of the KOffice Suite, so the Calligra packages will replace the KOffice packages.) or Abiword (A fully-featured word processor) + Gnumeric (A GNOME Spreadsheet Program): Depending on DE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-3"    "Latex" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-3-I"        "LaTeX: LaTeX is a popular markup language and document preparation system, often used in the sciences. The current implementation in Arch Linux is TeX Live. - https://wiki.archlinux.org/index.php/LaTeX" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-4"    "Calibre" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-4-I"        "calibre: Ebook management application" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-5"    "GcStar" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-5-I"        "gcstar: A collection management application" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-6"    "Homebank" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-6-I"        "homebank: Free, easy, personal accounting for everyone: http://homebank.free.fr/" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-7"    "Impressive" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-7-I"        "impressive: A fancy PDF presentation program (previously known as KeyJNote)." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-8"    "Nitrotasks" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-8-I"        "nitrotasks: An eyecandy task management tool" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-9"    "OCR Feeder" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-9-I"        "ocrfeeder: GTK+ document layout analysis and optical character recognition application" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-10"   "Xmind" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-10-I"       "xmind: Brainstorming and Mind Mapping Software - http://www.xmind.net/" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-11"   "Zathura" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-OFFICE-APPS-MENU-11-I"       "zathura: a document viewer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_office_apps_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # LibreOffice
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-OFFICE-APPS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-SYSTEM-APPS-DESC"  "Install System Tools Applications." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-NOTES" "Install System Tools Applications." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-TITLE" "Notes." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    # Gparted, Grsync, Htop, Virtualbox, Webmin, WINE
    localize_info "INSTALL-SYSTEM-APPS-MENU-1"   "Gparted" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-I-1"        "Gparted: A Partition Magic clone, frontend to GNU Parted. https://wiki.archlinux.org/index.php/GParted" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-2"   "Grsync" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-I-2"        "Grsync: GTK GUI for rsync" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-3"   "Htop" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-I-3"        "Htop: Interactive process viewer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-4"   "Virtualbox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-I-4"        "VirtualBox: is a virtual PC emulator like VMware - https://wiki.archlinux.org/index.php/VirtualBox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-5"   "Webmin" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-I-5"        "Webmin: runs as a service. Using webmin, you can administer other services and server configuration using a web browser, either from the server or remotely. https://wiki.archlinux.org/index.php/Webmin" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-6"   "WINE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SYSTEM-APPS-MENU-I-6"        "WINE: (originally an acronym for 'Wine Is Not an Emulator') is a compatibility layer capable of running Windows applications on several POSIX-compliant operating systems, such as Linux, Mac OSX, & BSD. https://wiki.archlinux.org/index.php/Wine" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_system_apps_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Gparted
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-SYSTEM-APPS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Grsync
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-GNOME-DE-EXTRAS-DESC"  "Install GNOME Desktop Extras" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-DE-EXTRAS-TITLE" "Gnome Desktop Environments Extras" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    # GNOME Icons, GTK Themes and even Unity
    localize_info "INSTALL-GNOME-DE-EXTRAS-MENU-1"    "GNOME Icons" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-DE-EXTRAS-MENU-1-I"      "GNOME Icons: awoken-icons faenza-icon-theme faenza-cupertino-icon-theme faience-icon-theme elementary-icons-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-DE-EXTRAS-MENU-2"    "GTK Themes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-DE-EXTRAS-MENU-2-I"      "GTK Themes: gtk-theme-adwaita-cupertino gtk-theme-boomerang xfce-theme-blackbird xfce-theme-bluebird egtk-bzr xfce-theme-greybird light-themes orion-gtk-theme zukini-theme zukitwo-themes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-DE-EXTRAS-MENU-3"    "Unity" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GNOME-DE-EXTRAS-MENU-3-I"      "Unity: Unity is an alternative shell for the GNOME desktop environment, developed by Canonical in its Ayatana project. It consists of several components including the Launcher, Dash, lenses, Panel, indicators, Notify OSD and Overlay Scrollbar. Unity used to available in two implementations: 'Unity' is the 3D accelerated version, which uses Compiz window manager and Nux toolkit; and 'Unity 2D' is a lighter alternative, which uses Metacity window manager and Qt toolkit. Unity 2D is already dropped by Canonical from Ubuntu 12.10." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_gnome_de_extras_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # GNOME Icons
                    ...
                    install_icons_menu
                    # Progress Status
                    StatusBar1="INSTALL-GNOME-DE-EXTRAS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # GTK Themes
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-GTK-THEMES-DESC"   "Install GTK Themes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-GTK-THEMES-MENU-1"    "Adwaita Cupertino" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-1"      "Adwaita Cupertino: Adwaita Cupertino GTK3 theme with matte and glassy metacity icons." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-2"    "Boomerang" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-2"      "Boomerang: A modern and well polished theme for GNOME desktop (gtk3, gtk2 and metacity)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-3"    "Blackbird" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-3"      "Blackbird: A dark, ink black Xfce theme, based off of Greybird" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-4"    "Bluebird" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-4"      "Bluebird: A light blue Xfce theme, introduced in the release of Xubuntu 10.10" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-5"    "eGTK" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-5"      "eGTK: Development branch of the elementary GTK theme." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-6"    "Greybird" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-6"      "Greybird: A grey and blue Xfce theme, introduced in the release of Xubuntu 11.04 and updated for 12.04; includes the classic low saturation theme" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-7"    "Light" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-7"      "Light: Ubuntu 'light' themes Ambiance and Radiance (GTK2 and GTK3)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-8"    "Orion" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-8"      "Orion: A modern and light GTK theme" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-9"    "Zukini" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-9"      "Zukini: A gtk2, gtk3, metacity, gnome-shell and unity theme..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-10"   "Zukitwo" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GTK-THEMES-MENU-I-10"     "Zukitwo: A theme for gtk3, gtk2, metacity, xfwm4, gnome-shell and unity..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_gtk_themes_menu() 
{ 
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Adwaita Cupertino
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-GTK-THEMES-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Boomerang
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-ICONS-DESC"   "Install ICONS: Install also the elementary XFCE icons"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-TITLE"  "GNOME ICONS"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-INFO-1" "Install also the elementary XFCE icons"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-ICONS-MENU-1"    "Awoken"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-I-1"       "Awoken: Simple and quite complete icon set, Token-style. awoken-icons"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-2"    "Faenza"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-I-2"       "Faenza: Faenza icon theme for KDE4. faenza-icon-theme"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-3"    "Faenza-Cupertino"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-I-3"       "Faenza-Cupertino: Icon theme designed for Equinox GTK theme, recolored. faenza-cupertino-icon-theme"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-4"    "Faience"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-I-4"       "Faience: An icon theme based on Faenza. faience-icon-theme"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-5"    "Elementary"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-I-5"       "Elementary: An icon theme designed to be smooth, sexy, clear, and efficient (Development branch). elementary-icons-bzr"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-6"    "Nitrux"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ICONS-MENU-I-6"       "Nitrux: new squared icon set for Linux that sports clean lines, smooth gradients, and simple icon logos. nitrux-icon-theme"  "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_icons_menu() 
{ 
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Awoken
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-INSTALL-ICONS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Faenza
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-GAMES-DESC"   "Install Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-TITLE"  "GAMES" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-GAMES-MENU-1"    "Action | Adventure" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-1"       "Action | Adventure: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-2"    "Arcade | Platformer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-2"       "Arcade | Platformer: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-3"    "Dungeon" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-3"       "Dungeon: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-4"    "Emulators" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-4"       "Emulators: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-5"    "FPS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-5"       "FPS: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-6"    "MMO" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-6"       "MMO: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-7"    "Puzzle" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-7"       "Puzzle: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-8"    "RPG" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-8"       "RPG: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-9"    "Racing" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-9"       "Racing: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-10"   "Simulation" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-10"      "Simulation: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-11"   "Strategy" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-11"      "Strategy: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-12"   "Gnome" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-12"      "Gnome: $INSTALL_GNOME_GAMES" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-13"   "KDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-13"      "KDE: $INSTALL_KDE_GAMES" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-14"   "Misc" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GAMES-MENU-I-14"      "Misc: $INSTALL_MISC_GAMES" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_games_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Action | Adventure
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-GAMES-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Arcade | Platformer
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-ACTION-GAMES-DESC"   "Install Action/Adventure Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-TITLE"  "Install Action/Adventure Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-ACTION-GAMES-MENU-1"   "Astromenace" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-I-1"        "Astromenace: Hardcore 3D space shooter with spaceship upgrade possibilities" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-2"   "Counter-Strike 2D" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-I-2"        "Counter-Strike 2D: A more than just a freeware clone of the well known game Counter-Strike" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-3"   "Dead Cyborg Episode 1" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-I-3"        "Dead Cyborg Episode 1: Free, donation based oldskool sci-fi adventure game with 3D first person view" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-4"   "M.A.R.S. Shooter" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-I-4"        "M.A.R.S. Shooter: A ridiculous space shooter with nice graphics" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-5"   "Nikki" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-I-5"        "Nikki: Nikki and the robots: A game where you take the role of Nikki and try to cross those evil plans on behalf of a secret organization." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-6"   "OpenTyrian" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-I-6"        "opentyrian-hg: OpenTyrian is a port of the DOS shoot-em-up Tyrian. This is a Port of the classic DOS game Tyrian" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-7"   "Sonic Robot Blast 2" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-I-7"        "Sonic Robot Blast 2: Sonic Robo Blast 2. A 3-D Sonic fan-game based off of Doom Legacy." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-8"   "Steelstorm" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-I-8"        "Steelstorm: a classic top down shooter, rife with explosions and things to explode, with a distinct visual style." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-9"   "Yo Frankie!" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACTION-GAMES-MENU-I-9"        "Yo Frankie!: A 3D platform game based on the bully rodent in Big Buck Bunny" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_action_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Astromenace
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-ACTION-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Counter-Strike 2D
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-ARCADE-GAMES-DESC"  "Install Arcade Platformer Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-TITLE" "Install Arcade Platformer Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-ARCADE-GAMES-MENU-1"     "Abuse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-1"         "Abuse: A side-scroller action game that pits you against ruthless alien killers." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-2"     "Battle Tanks" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-2"         "Battle Tanks: Fast 2d tank arcade game with multiplayer and split-screen modes." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-3"     "Bomberclone" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-3"         "Bomberclone: A clone of the game AtomicBomberMan." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-4"     "Those Funny Funguloids" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-4"         "Those Funny Funguloids: 3D game about collecting mushrooms in outerspace" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-5"     "Frogatto" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-5"         "Frogatto: An old-school 2d platformer game, starring a certain quixotic frog" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-6"     "Goonies" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-6"         "Goonies: A remake of the MSX Goonies game" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-7"     "Mari0" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-7"         "Mari0: The Mario game with Portal gun mechanics" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-8"     "Neverball" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-8"         "Neverball: 3D game similar to Super Monkey Ball or Marble Madness" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-9"     "Opensonic" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-9"         "Opensonic: Game based on the Sonic the Hedgehog Universe." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-10"    "Robombs" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-10"        "Robombs: A free LAN game inspired by Bomberman" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-11"    "Super Mario Chronicles" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-11"        "Super Mario Chronicles: Secret Maryo Chronicles" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-12"    "Xmoto" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ARCADE-GAMES-MENU-I-12"        "Xmoto: A challenging 2D motocross platform game, where physics play an important role." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_arade_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Abuse
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-ARCADE-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Battle Tanks
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-DUNGEON-GAMES-DESC"   "Install Dungon Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-DUNGEON-GAMES-MENU-1"    "Adom" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DUNGEON-GAMES-MENU-I-1"       "Adom: A roguelike game with a quest-centric, plot driven structure" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DUNGEON-GAMES-MENU-2"    "Tales of MajEyal" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DUNGEON-GAMES-MENU-I-2"       "Tales of MajEyal: An open-source, single-player, role-playing roguelike game set in the world of Eyal." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DUNGEON-GAMES-MENU-3"    "Lost Labyrinth" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DUNGEON-GAMES-MENU-I-3"       "Lost Labyrinth: RPG turn based game" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DUNGEON-GAMES-MENU-4"    "S.C.O.U.R.G.E." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DUNGEON-GAMES-MENU-I-4"       "S.C.O.U.R.G.E.: A rogue-like game with a 3d graphical front-end" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DUNGEON-GAMES-MENU-5"    "Stone-Soupe" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DUNGEON-GAMES-MENU-I-5"       "Stone-Soupe: An open-source, single-player, role-playing roguelike game of exploration and treasure-hunting" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_dungon_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Adom
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-DUNGEON-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Tales of MajEyal
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-EMULATORS-GAMES-DESC"   "Install Emulator Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-EMULATORS-GAMES-MENU-1"    "BSNES" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-I-1"        "BSNES: A library that exposes the core emulation of BSNES, a Super Nintendo Entertainment System (SNES) emulator." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-2"    "Desmume-svn" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-I-2"        "Desmume-svn: Nintendo DS emulator, svn version" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-3"    "Dolphin" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-I-3"        "Dolphin: A Gamecube / Wii / Triforce Emulator" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-4"    "Epsxe" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-I-4"        "Epsxe: Enhanced PSX emulator" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-5"    "Project 64" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-I-5"        "Project 64: A very popular and accurate Nintendo 64 Emulator (run via wine)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-6"    "Visual Boy Advanced" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-I-6"        "Visual Boy Advanced: Gameboy Advance Emulator combining features of all VBA forks - GTK GUI" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-7"    "wxmupen64plus" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-I-7"        "wxmupen64plus: A full-featured frontend for Mupen64Plus written using wxWidgets" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-8"    "zsnes" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMULATORS-GAMES-MENU-I-8"        "zsnes: Super Nintendo emulator" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_emulator_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # BSNES
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-EMULATORS-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Desmume-svn
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-FPS-GAMES-DESC"   "Install FPS Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-FPS-GAMES-MENU-1"    "Alienarena" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FPS-GAMES-MENU-I-1"      "Alienarena: Multiplayer retro sci-fi deathmatch game" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FPS-GAMES-MENU-2"    "Warsow" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FPS-GAMES-MENU-I-2"      "Warsow: Free online multiplayer competitive FPS based on the Qfusion engine" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FPS-GAMES-MENU-3"    "Wolfenstein" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FPS-GAMES-MENU-I-3"      "Wolfenstein: Enemy Territory is a completely free, standalone, team-based, multiplayer FPS. enemy-territory" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FPS-GAMES-MENU-4"    "World of Padman" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FPS-GAMES-MENU-I-4"      "World of Padman: Cartoon-style multiplayer first-person shooter" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FPS-GAMES-MENU-5"    "Xonotic" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FPS-GAMES-MENU-I-5"      "Xonotic: A free, fast-paced crossplatform first-person shooter" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_fps_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Alienarena
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-FPS-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Warsow
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-MMO-GAMES-DESC"   "Install MMO Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-MMO-GAMES-MENU-1"    "Heroes of Newerth" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-I-1"       "Heroes of Newerth: Heroes of Newerth is a Real Time Strategy game heavily influcenced by DotA" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-2"    "Manaplus" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-I-2"       "Manaplus: ManaPlus is a 2D MMORPG game advanced client for games based on eAthena fork The Mana World (tAthena) also for other forks like Evol." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-3"    "Runescape" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-I-3"       "Runescape: Runescape Client for Linux and Unix. unix-runescape-client" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-4"    "Savage 2" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-I-4"       "Savage 2: A Tortured Soul is an fantasy themed online multiplayer team-based FPS/RTS/RPG hybrid. Completely free as of December 2008." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-5"    "Spiral Knights" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-I-5"       "Spiral Knights: The Spiral Knights have awoken on an alien world. Their equipment stores have been raided and their starship, The Skylark, will not recover from the crash. They must work together to survive on a journey that will take them to the very core of the world." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-6"    "Wakfu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MMO-GAMES-MENU-I-6"       "Wakfu: A turn-based tactical Massively Multiplayer Online Role-playing Game (MMORPG) written in Java/OpenGL." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_mmo_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Heroes of Newerth
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-MMO-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Manaplus
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-PUZZLE-GAMES-DESC"   "Install Puzzle Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-PUZZLE-GAMES-MENU-1"    "frozen-bubble" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PUZZLE-GAMES-MENU-I-1"       "frozen-bubble: A game in which you throw colorful bubbles and build groups to destroy the bubbles" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PUZZLE-GAMES-MENU-2"    "Numptyphysics" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-PUZZLE-GAMES-MENU-I-2"       "Numptyphysics: a drawing puzzle game in the spirit of Crayon Physics" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_puzzle_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # frozen-bubble
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-PUZZLE-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Numptyphysics
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-RPG-GAMES-DESC"   "Install RPG GAMES" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-RPG-GAMES-MENU-1"    "Ardentryst" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RPG-GAMES-MENU-I-1"       "Ardentryst: An Action/RPG sidescoller with a focus on story and character development" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RPG-GAMES-MENU-2"    "Flare RPG" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RPG-GAMES-MENU-I-2"       "Flare RPG: Open Source Action Roleplaying Game" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RPG-GAMES-MENU-3"    "Freedroid RPG" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RPG-GAMES-MENU-I-3"       "Freedroid RPG: A Mature Science Fiction Role Playing game set in the future" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_rpg_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Ardentryst
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-RPG-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Flare RPG
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-RACING-GAMES-DESC"   "Install Racing Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-RACING-GAMES-MENU-1"    "Maniadrive" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RACING-GAMES-MENU-I-1"        "Maniadrive: An acrobatic racing game" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RACING-GAMES-MENU-2"    "Death Rally" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RACING-GAMES-MENU-I-2"        "Death Rally: A free windows port of the classic racing game from Remedy games, played in Wine." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RACING-GAMES-MENU-3"    "Stun Trally" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RACING-GAMES-MENU-I-3"        "Stun Trally: Stunt Rally game with track editor, based on VDrift and OGRE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RACING-GAMES-MENU-4"    "Supertuxkart" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RACING-GAMES-MENU-I-4"        "Supertuxkart: Kart racing game featuring Tux and his friends" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RACING-GAMES-MENU-5"    "Speed Dreams" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-RACING-GAMES-MENU-I-5"        "Speed Dreams: A racing simulator with rich graphics and physics" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_racing_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Maniadrive
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-RACING-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Death Rally
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-SIMULATION-GAMES-DESC"   "Install Simulation Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-SIMULATION-GAMES-MENU-1"    "Simutrans" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SIMULATION-GAMES-MENU-I-1"        "Simutrans: An Open Source Transportation Simulation Game" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SIMULATION-GAMES-MENU-2"    "Theme Hospital" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SIMULATION-GAMES-MENU-I-2"        "Theme Hospital: Reimplementation of the Game Engine of Theme Hospital. corsix-th" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SIMULATION-GAMES-MENU-3"    "Openttd" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SIMULATION-GAMES-MENU-I-3"        "Openttd: An Engine for Running Transport Tycoon Deluxe." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_simulation_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Simutrans
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-SIMULATION-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Theme Hospital
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-STRATEGY-GAMES-DESC"   "Install Strategy Games" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-STRATEGY-GAMES-MENU-1"    "0ad" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-I-1"          "0ad: Cross-platform, 3D and historically-based Real-Time Strategy Game" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-2"    "Hedgewars" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-I-2"          "Hedgewars: Free Worms-like turn based strategy game" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-3"    "Megaglest" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-I-3"          "Megaglest: Fork of Glest, a 3D Real-Time Strategy Game in a Fantastic World." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-4"    "Unknown-horizons" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-I-4"          "Unknown-horizons: A 2D Realtime Strategy Simulation with an emphasis on economy and City Building" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-5"    "Warzone2100" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-I-5"          "Warzone2100: 	3D Realtime Strategy Game on a future Earth" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-6"    "Wesnoth" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-I-6"          "Wesnoth: A turn-based Strategy Game on a fantasy world" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-7"    "Zod" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-STRATEGY-GAMES-MENU-I-7"          "Zod: The Zod Engine - An Open Source Remake of the 1996 Game Z by Bitmap Brothers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_strategy_games_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # 0ad
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-STRATEGY-GAMES-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Hedgewars
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then 
    localize_info "CREATE-SITES-FOLDER-DESC"   "Create Web Sites Folder" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "CREATE-SITES-FOLDER-INFO-1" "The folder (Sites) has been created in your home" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "CREATE-SITES-FOLDER-INFO-2" "You can access your Web Projects at" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
create_sites_folder()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-WEB-SERVER-DESC"  "Main Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WEB-SERVER-TITLE" "Web Server" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-WEB-SERVER-MENU-1"   "LAPP - APACHE, POSTGRESQL & PHP + ADMINER" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WEB-SERVER-MENU-I-1"         "POSTGRESQL: A Sophisticated Object-Relational DBMS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WEB-SERVER-MENU-2"   "LAMP - APACHE, MYSQL & PHP + ADMINER" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-WEB-SERVER-MENU-I-2"         "MYSQL: A fast SQL Database Server" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_web_server_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # POSTGRESQL
                    MenuChecks[$((S_OPT - 1))]=1
                    WEBSERVER="$S_OPT"
                    if add_packagemanager "package_install \"$INSTALL_POSTGRESQL\" 'INSTALL-WT-POSTGRESQL'" "INSTALL-WT-POSTGRESQL" ; then
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-WEB-SERVER-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # MYSQL
                    MenuChecks[$((S_OPT - 1))]=1
                    WEBSERVER="$S_OPT"
                    # @FIX add MySQL install package also
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-FONTS-DESC"     "Install Fonts" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-FONTS-MENU-1"    "ttf-dejavu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-I-1"       "ttf-dejavu: Font family based on the Bitstream Vera Fonts with a wider range of characters" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-2"    "ttf-google-webfonts" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-I-2"       "ttf-google-webfonts: Google Web Fonts catalogue. Note: Removes: ttf-droid ttf-roboto ttf-ubuntu-font-family" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-3"    "ttf-funfonts" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-I-3"       "ttf-funfonts: 76 selected TTF fonts from 6760 font packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-4"    "ttf-kochi-substitute" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-I-4"       "ttf-kochi-substitute: High quality Japanese TrueType fonts" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-5"    "ttf-liberation" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-I-5"       "ttf-liberation: Red Hats Liberation fonts." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-6"    "ttf-ms-fonts" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-I-6"       "ttf-ms-fonts: Core TTF Fonts from Microsoft" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-7"    "ttf-vista-fonts" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-I-7"       "ttf-vista-fonts: Microsoft Vista True Type Fonts" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-8"    "wqy-microhei" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-FONTS-MENU-I-8"       "wqy-microhei: A Sans-Serif style high quality CJK outline font. Chinese/Japanese/Korean Support" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_fonts_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # ttf-dejavu
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-FONTS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "GET-NETWORK-MANAGER-USAGE" "get_network_manager_menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "GET-NETWORK-MANAGER-DESC"  "Get Network Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "GET-NETWORK-MANAGER-NOTES" "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "GET-NETWORK-MANAGER-TITLE"    "Network Managers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "GET-NETWORK-MANAGER-MENU-1"   "Network Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "GET-NETWORK-MANAGER-MENU-1-I"    "NetworkManager: is a program for providing detection and configuration for systems to automatically connect to network. NetworkManager's functionality can be useful for both wireless and wired networks." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "GET-NETWORK-MANAGER-MENU-2"   "WICD" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "GET-NETWORK-MANAGER-MENU-2-I"    "Wicd: is a network connection manager that can manage wireless and wired interfaces, similar and an alternative to NetworkManager." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "GET-NETWORK-MANAGER-MENU-3"   "None" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "GET-NETWORK-MANAGER-MENU-3-I"    "Do not install any Network Manager." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
get_network_manager_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # networkmanager
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-NETWORK-MANAGER-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    S_OPT="$BreakableKey"
                    break
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-NETWORK-MANAGER-USAGE" "install_network_manager_now" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-NETWORK-MANAGER-DESC"  "Install Network Manager" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-NETWORK-MANAGER-NOTES" "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-NETWORK-MANAGER-WARN"  "No Network Manager Installed." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-ACCESSORIES-APPS-DESC"    "Install Accessory Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-TITLE"   "Accessory Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-1"    "Cairo Dock" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-1"       "Cairo-dock: is a highly customizable dock written in C. " "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-2"    "Conky + CONKY-colors" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-2"       "Conky + CONKY-colors: Lightweight system monitor for X. An easier way to configure Conky." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-3"    "Deepin Screenshot" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-3"       "Deepin Screenshot: a screen snapshot tool from deepin linux" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-4"    "Dockbarx" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-4"       "Dockbarx: TaskBar with groupping and group manipulation (with optional MATE support)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-5"    "Docky" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-5"       "Docky: Full fledged dock application that makes opening common applications and managing windows easier and quicker" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-6"    "Speedcrunch or galculator" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-6"       "Speedcrunch or galculator: Depending on DE -> Simple but powerful calculator using Qt or GTK+ based scientific calculator" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-7"    "Gnome Pie" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-7"       "Gnome Pie: A visual application launcher for gnome." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-8"    "Guake" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-8"       "Guake: Nice Terminal Popup F12" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-9"    "Kupfer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-9"       "Kupfer: Launcher application written in python. Similar to Gnome-Do / Launchy" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-10"   "Pyrenamer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-10"      "Pyrenamer: Mass file renamer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-11"   "Shutter" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-11"      "Shutter: A featureful screenshot tool (formerly gscrot)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-12"   "Synapse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-12"      "Synapse: A semantic file launcher and Zeitgeist client library" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-13"   "Terminator" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-13"      "Terminator: an application that provides lots of terminals in a single window and Library for registering global keyboard shortcuts - Python 2 bindings" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-14"   "Zim" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-14"      "Zim: A WYSIWYG text editor that aims at bringing the concept of a wiki to the desktop." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-15"   "Revelation" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ACCESSORIES-APPS-MENU-I-15"      "Revelation: Password Safe." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_accessories_apps_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Cairo
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-ACCESSORIES-APPS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-DEVELOPMENT-APPS-DESC"    "Install Development Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    MENU_NUMBER=1
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Qt and Creator" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"      # 1
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "Qt and Creator: A cross-platform application and UI framework" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Wt" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"                  # 2
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "Wt Pronounced [Witty]: C++ Web Applications Frame work based on Widgets." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "PostgreSQL" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"          # 3
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "PostgreSQL: A sophisticated Object-Relational DBMS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "MySQL and Workbench" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO" # 4
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "MySQL and Workbench: In AUR - DBMS - Commercial License." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Aptana-Studio" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"       # 5
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "Aptana-Studio: The professional, open source development tool for the open web." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Bluefish" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"            # 6
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "Bluefish: A powerful HTML editor for experienced web designers and programmers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Eclipse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"             # 7
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "Eclipse: An IDE for Java and other languages - Sub menu for Customizing." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Emacs" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"               # 8
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "emacs: The extensible, customizable, self-documenting real-time display editor" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "gVim" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"                # 9
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "gvim: Vi Improved, a highly configurable, improved version of the vi text editor (with advanced features, such as a GUI)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Geany" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"               # 10
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                   "geany: Fast and lightweight IDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "IntelliJ IDEA" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"       # 11
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "IntelliJ IDEA: IDE for Java, Groovy and other programming languages with advanced refactoring features" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "kDevelop" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"            # 12
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "kdevelop: A C/C++ development environment for KDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Netbeans" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"           # 13
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "Netbeans: IDE for Java, PHP, Groovy, C, C++ and Python" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Oracle Java" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"        # 14
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "Oracle Java: Java 7 Development Kit - https://wiki.archlinux.org/index.php/Java & http://www.oracle.com/technetwork/java/javase/downloads/index.html" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"    
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Sublime Text 2" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"     # 15
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "Sublime Text 2: sophisticated text editor for code, html and prose" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Debugger Tools" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"     # 16
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "Debugger Tools: $AUR_INSTALL_DEBUGGER_TOOLS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Meld" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"               # 17
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "meld: Visual diff and merge tool" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "RabbitVCS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"          # 18
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "RabbitVCS: A project with the goal of developing a collection of utilities to allow for better client integration with some of the popular version control systems (core)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "aStyle" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"             # 19
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "astyle: A free, fast and small automatic formatter for C, C++, C#, and Java source code." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Putty" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"              # 20
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "putty: A terminal integrated SSH/Telnet client" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Utilities" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"          # 21
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "Utilities: $INSTALL_UTILITES" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$MENU_NUMBER"         "Panda3D Runtime" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"          # 21
    localize_info "INSTALL-DEVELOPMENT-APPS-MENU-$((MENU_NUMBER++))-I"                  "Panda3D Runtime: http://www.panda3d.org/download.php?runtime" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_development_apps_menu()
{
    ...
    while [[ 1 ]]; do
        ...
        add_menu_item "MenuChecks" "MenuItems" "MenuInfo" "INSTALL-DEVELOPMENT-APPS-MENU-22" "" ""          "INSTALL-DEVELOPMENT-APPS-MENU-22-I" "MenuTheme[@]" # 22 Panda3D Runtime
        #
        print_menu "MenuItems[@]" "MenuInfo[@]" "$BreakableKey"
        #
        read_input_options "$RecommendedOptions" "$BreakableKey"
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Qt and Creator
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-DEVELOPMENT-APPS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Wt
               ...
               22)  # panda3d
                    MenuChecks[$((S_OPT - 1))]=1
                    if add_packagemanager "package_install \"$INSTALL_PANDA3D\" 'INSTALL-PANDA3D'" "INSTALL-PANDA3D" ; then
                        add_package "$INSTALL_PANDA3D"
                    fi
                    if add_packagemanager "aur_package_install \"$AUR_INSTALL_PANDA3D\" 'AUR-INSTALL-PANDA3D'" "AUR-INSTALL-PANDA3D" ; then
                        add_aur_package "$AUR_INSTALL_PANDA3D"
                    fi
                    # Progress Status
                    StatusBar1="INSTALL-DEVELOPMENT-APPS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-ECLIPSE-DEV-DESC"   "Install Eclipse Dev" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ECLIPSE-DEV-INFO-1" "Eclipse is an open source community project, which aims to provide a universal development platform." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-ECLIPSE-DEV-MENU-1" "Eclipse IDE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ECLIPSE-DEV-MENU-2" "Eclipse IDE for C/C++ Developers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ECLIPSE-DEV-MENU-3" "Android Development Tools for Eclipse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ECLIPSE-DEV-MENU-4" "Web Development Tools for Eclipse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ECLIPSE-DEV-MENU-5" "PHP Development Tools for Eclipse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ECLIPSE-DEV-MENU-6" "Python Development Tools for Eclipse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ECLIPSE-DEV-MENU-7" "Aptana Studio Plugin for Eclipse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ECLIPSE-DEV-MENU-8" "Vim-like Editing Plugin for Eclipse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-ECLIPSE-DEV-MENU-9" "Git support Plugin for Eclipse" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_eclipse_dev_menu()
{
    ...
    if [[ "$INSTALL_TYPE" -eq 0 ]]; then   # Normal
        ...
        RecommendedOptions="$RecommendedOptions 3 5 6"    
    fi
    #
    RecommendedOptions="$RecommendedOptions $BreakableKey"
    #
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Eclipse IDE
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-ECLIPSE-DEV-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-INTERNET-APPS-DESC"  "Install Internet Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-APPS-TITLE" "Internet Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    # Browsers, Download / Fileshare, Email / RSS, Instant Messaging, Internet Relay Chat, Mapping Tools, VNC / Desktop Share
    localize_info "INSTALL-INTERNET-MENU-1"     "Browsers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-I-1"       "Browsers: Sub Menu: Firefox, Chrome, Opera" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-2"     "Download / Fileshare" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-I-2"       "Download / Fileshare: Transmission" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-3"     "Email / RSS" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-I-3"       "Email / RSS: Evolution, Firebird" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-4"     "Instant Messaging" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-I-4"       "Instant Messaging (IM): Pidgin, Skype" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-5"     "Internet Relay Chat" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-I-5"       "Internet Relay Chat (IRC): xchat" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-6"     "Mapping Tools" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-I-6"       "Mapping Tools: Google Map, NASA" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-7"     "VNC / Desktop Share" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-INTERNET-MENU-I-7"       "VNC / Desktop Share: " "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_internet_apps_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Browser
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-INTERNET-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-BROWSERS-DESC"     "Install Internet Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BROWSERS-TITLE"    "Web Browsers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-BROWSERS-MENU-1"   "Firefox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BROWSERS-MENU-2"   "Chromium" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BROWSERS-MENU-3"   "Google Chrome" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BROWSERS-MENU-4"   "Opera" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BROWSERS-MENU-5"   "Rekonq or Midori" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-BROWSERS-MENU-5-I" "Rekonq or Midori: Depending on DE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_browsers_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # 
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-BROWSERS-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # 
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-DOWNLOAD-FILESHARE-DESC"   "Install Download / Fileshare Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-1"   "Transmission" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-I-1"      "Transmission: Transmission is a light-weighted and cross-platform BitTorrent client. It is the default BitTorrent client in many Linux distributions." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-2"   "Deluge" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-I-2"      "Deluge: Deluge is a lightweight, BitTorrent client written in python that offers users a powerful client/server architecture. Once a headless daemon has been setup, user can interact with it in three ways including a WebUI, GTK-UI, and console interface." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-3"   "Dropbox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    ...
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-4"   "Insync" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-I-4"      "Insync: An unofficial Google Drive client that runs on Linux, with support for various desktops" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-5"   "JDownloader" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-I-5"      "JDownloader: JDownloader is a Download Manager written in Java. JDownloader can download normal files, but also files from online file hosting services like Rapidshare.com." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-6"   "Nitroshare" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-I-6"      "Nitroshare: Makes sending a file to another machine on the local network as easy as dragging-and-dropping" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-7"   "Sparkleshare" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-I-7"      "Sparkleshare: An open-source clone of Dropbox, written in Mono" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-8"   "Steadyflow" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DOWNLOAD-FILESHARE-MENU-I-8"      "Steadyflow: steadyflow-bzr is a download manager that aims for minimalism, ease of use, and a clean, malleable codebase" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_download_fileshare_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Transmission
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-DOWNLOAD-FILESHARE-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # deluge
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-EMAIL-DESC"     "Install Email / RSS Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-EMAIL-MENU-1"    "Evolution" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMAIL-MENU-I-1"         "Evolution: Evolution is a GNOME mail client it supports IMAP, Microsoft Exchange Server and Novell GroupWise. It also has a calender function that supports vcal,csv, google calendar and many more. You can also organise your contacts, tasks and memos with Evolution. The beautiful thing about evolution is that it's easy to use and integrates with the gnome environment. You can see your calendar, tasks and location in the GNOME panel along with the weather and date. Just add the clock to your gnome panel." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMAIL-MENU-2"    "Thunderbird" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMAIL-MENU-I-2"         "Thunderbird: Mozilla Thunderbird is an email, newsgroup, and news feed client designed around simplicity and full-featuredness while avoiding bloat. It supports POP, IMAP, SMTP, S/MIME, and OpenPGP encryption (through the Enigmail extension). Similarly to Firefox, it has a wide variety of extension and addons available for download that add more features." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMAIL-MENU-3"    "Liferea" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMAIL-MENU-I-3"         "Liferea: A desktop news aggregator for online news feeds and weblogs" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMAIL-MENU-4"    "Lightread" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-EMAIL-MENU-I-4"         "Lightread: A totally awesome offline Google Reader." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_email_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Evolution
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-EMAIL-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Thunderbird
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-IM-DESC"   "Install IM - Instant Messaging" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-IM-MENU-1"   "Pidgin" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IM-MENU-I-1"      "Pidgin: Multi-protocol instant messaging client" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IM-MENU-2"   "Skype" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IM-MENU-I-2"      "Skype: P2P software for high-quality voice communication - with a Commercial License." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IM-MENU-3"   "Emesene" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IM-MENU-I-3"      "Emesene: A pygtk MSN Messenger client" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IM-MENU-4"   "Google Talkplugin" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IM-MENU-I-4"      "Google Talkplugin: Video chat browser plug-in for Google Talk" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IM-MENU-5"   "Teamspeak3" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IM-MENU-I-5"      "Teamspeak3: TeamSpeak is software for quality voice communication via the Internet" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_im_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Pidgin
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-IM-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Skype
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-IRC-DESC"   "Install IRC - Internet Relay Chat" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-IRC-MENU-1"   "irssi" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IRC-MENU-I-1"     "irssi: Modular text mode IRC client with Perl scripting" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IRC-MENU-2"   "quassel or xchat" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-IRC-MENU-I-2"     "quassel or xchat: quassel (QT4 irc client with a separated core) or xchat (A GTK+ based IRC client): Depending on DE" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_irc_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # irssi
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-IRC-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # quassel or xchat
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-MAPPING-DESC"     "Install Mapping Tools" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-MAPPING-MENU-1"   "Google Earth" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAPPING-MENU-I-1"        "Google Earth: Google Earth lets you fly anywhere on Earth to view satellite imagery, maps, terrain, 3D buildings, from galaxies in outer space to the canyons of the ocean. You can explore rich geographical content, save your toured places, and share with others." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAPPING-MENU-2"   "NASA World Wind" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-MAPPING-MENU-I-2"        "NASA World Wind: An Open Source 3D Interactive World viewer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_mapping_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Google Earth
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-MAPPING-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # NASA World Wind
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-DESKTOP-SHARE-DESC"   "Install Desktop Share" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-SHARE-MENU-1"   "Remmina" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-SHARE-MENU-I-1"       "Remmina: Remmina is a remote desktop client written in GTK+." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-SHARE-MENU-2"   "Teamviewer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-DESKTOP-SHARE-MENU-I-2"       "Teamviewer: All-in-one solution for accessing PC's using the internet - has Commercial license." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_desktop_share_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Remmina
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-DESKTOP-SHARE-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Teamviewer
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-GRAPHICS-APPS-DESC"   "Install Graphic Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-GRAPHICS-APPS-TITLE"    "Graphic Applications" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    ...
    localize_info "INSTALL-GRAPHICS-APPS-MENU-1"    "AV Studio" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-1"          "AV Studio: Installs all Below and more Audio and Video Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-2"    "Blender" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-2"          "Blender: A fully integrated 3D graphics creation suite." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-3"    "Handbrake" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-3"          "Handbrake: Multithreaded video transcoder" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-4"    "CD/DVD Burners" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-4"          "CD/DVD Burners: brasero (A disc burning application for Gnome), dvd+rw-tools (DVD burning tools), dvdauthor (DVD authoring tools), Gnomebaker (AUR: A full featured CD/DVD burning application for Gnome), k3b (Feature-rich and easy to handle CD burning application) and Xfburn" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-5"    "Gimp" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-5"          "Gimp: GNU Image Manipulation Program" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-6"    "Gimp-plugins" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-6"          "Gimp-plugins: GNU Image Manipulation Program Plugins." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-7"    "Gthumb" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-7"          "Gthumb: Image browser and viewer for the GNOME Desktop" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-8"    "Inkscape" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-8"          "Inkscape: Vector graphics editor using the SVG file format" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-9"    "Mcomix" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-9"          "Mcomix: A user-friendly, customizable image viewer specifically designed to handle comic books" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-10"   "MyPaint" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-10"         "MyPaint: A fast and easy painting application for digital painters, with brush dynamics" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-11"   "Scribus" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-11"         "Scribus: A desktop publishing program" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-12"  "Shotwell" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-12"         "Shotwell: A digital photo organizer designed for the GNOME desktop environment" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-13"   "Simple-scan" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-13"         "Simple-scan: Simple scanning utility" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-14"   "Xnviewmp" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-14"         "Xnviewmp: An efficient multimedia viewer, browser and converter (beta release)." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-15"   "Qt Image Viewers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-15"         "Qt Image Viewers: nomacs, limoo, qiviewer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-16"   "Qt Image Editors" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-GRAPHICS-APPS-MENU-I-16"         "Image Editors: easypaint-git, pencil-svn" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
...
install_graphics_apps_menu()
{
    ...
    #
    if [[ "$INSTALL_TYPE" -eq 0 ]]; then   # Normal
        RecommendedOptions="$RecommendedOptions 3-5 7-13"        
    elif [[ "$INSTALL_TYPE" -eq 1 ]]; then # Gamer
        RecommendedOptions="$RecommendedOptions 1"        
    elif [[ "$INSTALL_TYPE" -eq 2 ]]; then # Professional
        RecommendedOptions="$RecommendedOptions 1"        
            ...
            case "$S_OPT" in
                1)  # AV Studio
                    ...
                    if add_packagemanager "package_install \"$INSTALL_BLENDER\" 'INSTALL-BLENDER'" "INSTALL-BLENDER" ; then
                        ...
                        # if [[ "${VIDEO_CARDS[$(( $VIDEO_CARD - 1 ))]" == 'nVidia' ]]; then
                        if [[ "$VIDEO_CARD" -eq 1 ]]; then
                            if add_packagemanager "package_install \"$INSTALL_BLENDER_CUDA\" 'INSTALL-BLENDER-CUDA'" "INSTALL-BLENDER-CUDA" ; then
                                add_package "$INSTALL_BLENDER_CUDA"
                            fi
                        fi
                    fi
                    ...
                    # Fails if add_packagemanager "aur_package_install \"$AUR_INSTALL_GIMP_PLUGINS\" 'AUR-INSTALL-GIMP-PLUGINS'" "AUR-INSTALL-GIMP-PLUGINS" ; then add_aur_package "$AUR_INSTALL_GIMP_PLUGINS"; fi
                    # Progress Status
                    StatusBar1="INSTALL-GRAPHICS-APPS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Blender
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-VIDEO-APPS-DESC"     "Install Video Apps" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    # Players, Editors \ Tools, Codecs
    localize_info "INSTALL-VIDEO-APPS-MENU-1"   "Players" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-APPS-MENU-I-1"     "Players: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-APPS-MENU-2"   "Editors / Tools" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-APPS-MENU-I-2"     "Editors / Tools: Sub Menu" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-APPS-MENU-3"   "Codecs" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-APPS-MENU-I-3"     "Codecs: $AUR_INSTALL_CODECS_64" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_video_apps_menu()
{
        ...
        for S_OPT in ${OPTIONS[@]}; do
            case "$S_OPT" in
                1)  # Players
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-VIDEO-APPS-MENU-$S_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Editors | Tools
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-VIDEO-PLAYERS-DESC"   "Install Video Players" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"

    localize_info "INSTALL-VIDEO-PLAYERS-MENU-1"   "Audience-bzr" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-I-1"       "Audience-bzr: A simple and modern media player." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-2"   "Gnome-mplayer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-I-2"       "Gnome-mplayer: A simple MPlayer GUI." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-3"   "Parole" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-I-3"       "Parole: A modern media player based on the GStreamer framework" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-4"   "MiniTube" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-I-4"       "MiniTube: A native YouTube client in QT. Watch YouTube videos without Flash Player" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-5"   "Miro" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-I-5"       "Miro: The free and open source internet TV platform" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-6"   "Rosa Media Player" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-I-6"       "Rosa Media Player: The new multimedia player(based on SMPlayer) with clean and elegant UI." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-7"   "smplayer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-I-7"       "smplayer: A complete front-end for MPlayer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-8"   "VLC" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-I-8"       "VLC: A multi-platform MPEG, VCD/DVD, and DivX player" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-9"   "XBMC" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-PLAYERS-MENU-I-9"       "XBMC: A software media player and entertainment hub for digital media" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_video_players_menu()
{
    ...
    while [[ 1 ]]; do
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Audience-bzr currently fails
                    MenuChecks[$((SS_OPT - 1))]=1
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-VIDEO-PLAYERS-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Gnome-mplayer
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-DESC"  "Install Video Editors Tools" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-TITLE" "Video Editors and Tools" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-1"   "Arista-transcoder" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-I-1"        "Arista-transcoder: Easy to use multimedia transcoder for the GNOME Desktop" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-2"   "Transmageddon" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-I-2"        "Transmageddon: Simple python application for transcoding video into formats supported by GStreamer" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-3"   "KDEenlive" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-I-3"        "KDEenlive: A non-linear video editor for Linux" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-4"   "Openshot" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-I-4"        "Openshot: An Open-Source, non-linear video editor for Linux based on MLT framework" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-5"   "Pitivi" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-I-5"        "Pitivi: Editor for audio/video projects using the GStreamer framework" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-6"   "Kazam" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-EDITORS-TOOLS-MENU-I-6"        "Kazam-bzr: A screencasting program with design in mind. Unstable branch." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_video_editors_tools_menu()
{
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # Arista-transcoder
                    ...
                    # Progress Status
                    StatusBar1="INSTALL-VIDEO-EDITORS-TOOLS-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    ;;
                2)  # Transmageddon
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-SCIENCE-DESC"   "Install Science and Education" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_science()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-VIDEO-CARD-NOW-DESC"   "Install Video Card" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARD-NOW-WARN"   "No Video Card installed" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-VIDEO-CARDS-USAGE" "install_video_cards_menu 1->(1=Install, 2=Remove)" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-DESC"  "Install Video Card" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-NOTES" "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-VIDEO-CARDS-TITLE"  "Video Cards" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    # nVidia, Nouveau, Intel, ATI, Vesa, Virtualbox
    localize_info "INSTALL-VIDEO-CARDS-MENU-1"   "nVidia" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-1-I"          "nVidia: https://wiki.archlinux.org/index.php/NVIDIA" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-2"   "Nouveau" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-2-I"          "Nouveau: https://wiki.archlinux.org/index.php/Nouveau" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-3"   "Intel" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-3-I"          "Intel: https://wiki.archlinux.org/index.php/Intel_Graphics" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-4"   "ATI" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-4-I"          "ATI: https://wiki.archlinux.org/index.php/ATI" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-5"   "Vesa" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-5-I"          "Vesa: https://wiki.archlinux.org/index.php/Xorg" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-6"   "Virtualbox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-6-I"          "Virtualbox: Setup a Virtual Display Card: https://wiki.archlinux.org/index.php/VirtualBox" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-7"   "Skip" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-VIDEO-CARDS-MENU-7-I"          "Skip: Do not install any Video Card." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
        ...
        for SS_OPT in ${OPTIONS[@]}; do
            case "$SS_OPT" in
                1)  # nVidia
                    ...
                    #fi
                    # Progress Status
                    StatusBar1="INSTALL-VIDEO-CARDS-MENU-$SS_OPT"
                    StatusBar2=$(localize "INSTALL-MENU-COMPLETED")
                    print_caution "$StatusBar1"  "$StatusBar2"
                    SS_OPT="$BreakableKey"
                    break
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "TEST-INSTALLATION-DESC"           "Test Install" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "TEST-INSTALLATION-NOTES"          "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "TEST-INSTALLATION-INFO"           "Test Install" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "TEST-INSTALLATION-CORE"           "Testing Core Packages." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "TEST-INSTALLATION-AUR"            "Testing AUR Packages." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "TEST-INSTALLATION-CORE-INSTALLED" "Core Package Installed" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "TEST-INSTALLATION-AUR-INSTALLED"  "AUR Package Installed" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "TEST-INSTALLATION-CORE-WARN"      "pacman Did Not find Core Package:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "TEST-INSTALLATION-AUR-WARN"       "pacman Did Not find AUR Package:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "TEST-INSTALLATION-LOG"            "pacman Install Error Log." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
test_installation()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "REINSTALLATION-DESC"           "Re-Install all Packages" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "REINSTALLATION-NOTES"          "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "REINSTALLATION-INFO"           "Reinstall" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "REINSTALLATION-CORE"           "Retry Core Packages." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "REINSTALLATION-AUR"            "Retry AUR Packages." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "REINSTALLATION-CORE-INSTALLED" "Core Package Installed" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "REINSTALLATION-AUR-INSTALLED"  "AUR Package Installed" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "REINSTALLATION-CORE-WARN"      "pacman Did Not find Core Package:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "REINSTALLATION-AUR-WARN"       "pacman Did Not find AUR Package:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
reinstallation()
{
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-SOFTWARE-LIVE-DESC"  "Test functions out for Developers" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-NOTES" "Calls finish 2, so exit 0 after calling this. All the Custom scripts should be written to Package Manager, so after testing, move them there, only allow custom scripts in testing mode only." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-SOFTWARE-LIVE-TITLE"  "Arch Linux Software Installation" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-1" "Configure Pacman Package Signing..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-2" "System Upgrade..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-3" "Configure AUR Helper..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-4" "Set host name..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-5" "Hostname is set: " "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-6" "Hostname is not set!" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-7" "Configure TOR..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-8" "Configure KDE..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-9" "Configure SSH..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-10" "Configure XORG..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-11" "Fontconfig is a library designed to provide a list of available fonts to applications, and also for configuration for how fonts get rendered." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-12" "Enter your new postgres account password:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-13" "Enter your postgres account password:" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-LIVE-INFO-14" "Clean Orphan Packages..." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-WARN"         "You must run this in Live Mode!" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-WARN-2"       "Configuration did not get Loaded, make sure to run load_software or load_last_config" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-FAIL-1"       "Failed to Execute" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-SOFTWARE-PASSED"       "Executed Successfully" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
install_software_live()
{
    ...
    if [[ "$POSTGRESQL" -eq 1 ]]; then    
        ...
        add_packagemanager "systemctl enable httpd.service postgresql.service" "SYSTEMD-ENABLE-POSTGRESQL"
...
if [[ "$RUN_LOCALIZER" -eq 1 ]]; then
    localize_info "INSTALL-LOAD-SOFTWARE-DESC"  "Install loaded Software" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LOAD-SOFTWARE-NOTES" "None." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-LOAD-SOFTWARE-TITLE-1" "Install Software from Configuration files, Assumes you are in Live Mode, meaning you booted into your Live OS, not an installation disk." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LOAD-SOFTWARE-INFO-1" "Install Software from Configuration files, Assumes you are in Live Mode, meaning you booted into your Live OS, not an installation disk." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LOAD-SOFTWARE-INFO-2" "This option Assumes that you have a bootable OS and and have gone through the Application Software Menu and Saved it, now we are going to load it and install it." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LOAD-SOFTWARE-INFO-3" "Normally you will use the user name (&#36;USERNAME) in the file, but its possible that you may wish to use another User Name to install this with, make sure User Name Exist in this OS before doing this." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LOAD-SOFTWARE-INFO-4" "You will have to abort (Ctrl-C) if you wish to change Software Installation Setting, pick New Software Configuration." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LOAD-SOFTWARE-INFO-5" "Load Last Install." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    #
    localize_info "INSTALL-LOAD-SOFTWARE-WARN-1" "Live mode only" "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
    localize_info "INSTALL-LOAD-SOFTWARE-WARN-2" "No Software Configuration files found!, run option to create Configuration files and Save Configuration." "Comment: FunctionName @ $(basename $BASH_SOURCE) : $LINENO"
fi
# -------------------------------------
