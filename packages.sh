...
#
INSTALL_AWESOME="awesome lxappearance leafpad epdfview nitrogen ttf-bitstream-vera ttf-dejavu ttf-freefont giblib feh imagemagic libpng gnome-terminal gedit dex rlwrap vicious scrot lxappearance" # consolekit
