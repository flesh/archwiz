...
AUR_SCIENCE="gimp-plugin-astronomy skychart starplot"
#
...
INSTALL_TINT2="tint2"
INSTALL_VOLWHEEL="volwheel"
INSTALL_XFCE_PACKAGE=" xfce4 xfce4-goodies automake bash perl wmctrl gvfs gvfs-smb gvfs-afc ttf-bitstream-vera ttf-dejavu ttf-freefont gamin hicolor-icon-theme polkit-gnome xdg-user-dirs"
...
INSTALL_WEB_SERVER_1="apache postgresql php php-apache php-pgsql php-gd"
...
#
INSTALL_CD_DVD_BURNERS="brasero dvd+rw-tools dvdauthor acetoneiso2 k3b xfburn"
...
AUR_INSTALL_PLASMA_THEMES="caledonia-bundle plasma-theme-rosa ronak-plasmatheme" # plasma-theme-produkt
