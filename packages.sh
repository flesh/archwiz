...
AUR_INSTALL_EP_AUDIENCE="audience-bzr" # fails https://aur.archlinux.org/packages/audience-bzr/ missing clutter-gst-1.0 
...
AUR_INSTALL_DEEPIN_SCROT="deepin-scrot-git"
